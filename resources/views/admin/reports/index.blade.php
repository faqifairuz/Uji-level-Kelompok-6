    ...
    <div class="p-6">
        ...
        <div class="card-dark p-6 rounded-2xl border border-gray-800 shadow-xl max-w-2xl">
            ...
            <form action="{{ route('admin.reports.pdf') }}" method="GET" target="_blank" class="space-y-6">
                ...
                <div class="pt-4 border-t border-gray-800 flex items-center space-x-4">
                    <button type="submit" formaction="{{ route('admin.reports.pdf') }}" class="btn-orange px-6 py-3 rounded-xl font-bold text-sm shadow-lg flex items-center space-x-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                        <span>Cetak PDF</span>
                    </button>
                    
                    <button type="submit" formaction="{{ route('admin.reports.excel') }}" class="px-6 py-3 rounded-xl font-bold text-sm shadow-lg flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white transition-all">
